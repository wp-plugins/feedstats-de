...
#feeds_button {
	...
	color: #fff;
	background: url(wp-content/plugins/feedstats/feedstats.gif) no-repeat;
	margin-bottom: 2px;
}

Example for style-css in traditional Chinese (zh_TW) translation:
------------------------------------------------------
	background: url(wp-content/plugins/feedstats/feedstats-zh_TW.gif) no-repeat;
*/

if(function_exists('load_plugin_textdomain')) {
	load_plugin_textdomain('feedstats', 'wp-content/plugins/feedstats');
}

$location = get_option('siteurl') . '/wp-admin/options-general.php?page=feedstats/feedstats.php'; // Form Action URI
...
?>
	...
	<div class="wrap">
		...
		<p><a href="index.php?page=feedstats/feedstats.php&amp;fs_action=reset" onclick="return confirm('<?php echo _e('You are about to delete all data and reset stats. OK to delete, Cancel to stop', 'feedstats'); ?>');">&raquo;&raquo; <?php echo _e('Reset Statistic', 'feedstats'); ?> &laquo;&laquo;</a></p>
	</div>
...
function FeedStats_Admin_Header() {
	...
	$fs_feed_button_style.= '#feeds_button {
		...
		padding: 1px 15px 15px 3px;
		color: #fff;
		background: url('.get_settings('home').'/wp-content/plugins/feedstats/feedstats.gif) no-repeat 0 1px;
		margin: 0;
	}';
...
function FeedStats_Admin_Footer() {
	...
	$content = '<h3>' . __('FeedStats', 'feedstats') . ' <a href="admin.php?page=feedstats/feedstats.php">&raquo;</a></h3>';
...
if ( function_exists('add_action') ) {
	...
	if (strpos($_SERVER['REQUEST_URI'], 'page=feedstats/feedstats') !== false) {
